...
// ChainGetBlockSimpleMessages mocks base method
func (m *MockFullNode) ChainGetBlockSimpleMessages(arg0 context.Context, arg1 cid.Cid) (*api.SimpleBlockMessages, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ChainGetBlockSimpleMessages", arg0, arg1)
	ret0, _ := ret[0].(*api.SimpleBlockMessages)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ChainGetBlockSimpleMessages indicates an expected call of ChainGetBlockSimpleMessages
func (mr *MockFullNodeMockRecorder) ChainGetBlockSimpleMessages(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ChainGetBlockSimpleMessages", reflect.TypeOf((*MockFullNode)(nil).ChainGetBlockSimpleMessages), arg0, arg1)
}
