...
func FullNodeHandler(v1 v1api.FullNode, v2 v2api.FullNode, permissioned bool, authEndpoint, authToken string, opts ...jsonrpc.ServerOption) (http.Handler, error) {
	m := mux.NewRouter()
	...
	serveRpc := func(path string, hnd interface{}) {
		...
		if permissioned {
			if remoteJwtCli != nil {
				handler = (http.Handler)(jwtclient.NewAuthMux(&WrapClient{v1},
